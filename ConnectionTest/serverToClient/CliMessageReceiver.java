...
public class CliMessageReceiver implements Runnable {
     ...
     * This also means that the CliMessageReceiver needs reference to 
     * each of the receivers. It's constructor will need to be updated.
     * */
    
    public CliMessageReceiver(Socket clientSocket,
